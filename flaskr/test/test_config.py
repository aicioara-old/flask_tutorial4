...
from flaskr.main.config import basedir


class TestDevelopmentConfig(TestCase):
    def create_app(self):
        app.config.from_object('flaskr.main.config.DevelopmentConfig')
        return app
...
class TestTestingConfig(TestCase):
    def create_app(self):
        app.config.from_object('flaskr.main.config.TestingConfig')
        return app
...
class TestProductionConfig(TestCase):
    def create_app(self):
        app.config.from_object('flaskr.main.config.ProductionConfig')
        return app
